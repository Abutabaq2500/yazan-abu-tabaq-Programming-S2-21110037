...
public class account_creation {
	...
	public static void main(String[] args)
	{
		...
		account_creation ubj = new account_creation();
	...
	public static void sign_in() {
		...
		while(!username.equals("exit") && !password.equals("exit") && !login.equals("exit"))  /*username != "exit" && password != "exit"*/
		{
			System.out.println("");
			...
			if(my_username.equals(new_username) && my_password.equals(new_password) && !my_username.equals("exit") && !my_password.equals("exit")) //&& username.equals(my_username) && password.equals(my_password))
			{
				System.out.println("");
